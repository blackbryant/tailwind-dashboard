<template>
  <div class="relative flex min-h-screen">
    <div class="bg-cyan-600 text-cyan-100 w-64 space-x-6">
        <a href="" class="flex item-center space-x-2 px-4 no-underline">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75l2.25-1.313M12 21.75V19.5m0 2.25l-2.25-1.313m0-16.875L12 2.25l2.25 1.313M21 14.25v2.25l-2.25 1.313m-13.5 0L3 16.5v-2.25" />
            </svg>
            <span class="text-ml font-extrabold text-white">後台管理</span>
        </a>
        <nav>
            <a href="/" class="flex items-center space-x-2 py-3 px-4  no-underline">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none"  stroke-width="1.5" stroke="currentColor"  class="w-6 h-6 fill-white">
            ...
            <a href="" class="flex items-center space-x-2 py-3 px-4 no-underline">
                ...
                <span class="text-white">Calender</span>
            </a>
            <a href="" class="">
    ...
    <!--Main-->
    <div class="flex-1">
        <div class="bo-white shadow px-2 py-4">Header</div>    
        <div class="p-8 text-cyan-700 font-extrabold">Main</div>  
    </div>
  </div>
</template>
